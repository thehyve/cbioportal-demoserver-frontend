...
export interface ISurvivalTabTable {
    store: StudyViewPageStore;
}

class SurvivalTabTableComponent extends LazyMobXTable<{
    [id: string]: string;
}> {}

@observer
export class SurvivalTab extends React.Component<ISurvivalTabTable, {}> {
