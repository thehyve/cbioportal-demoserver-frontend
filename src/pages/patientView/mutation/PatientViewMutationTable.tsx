...
export default class PatientViewMutationTable extends MutationTable<IPatientViewMutationTableProps> {
    ...
    protected generateColumns() {
        ...
        this._columns[MutationTableColumnType.SAMPLES] = {
            name: "Samples",
            render:(d:Mutation[])=>TumorColumnFormatter.renderFunction(d, this.props.sampleManager, this.props.sampleToGenePanelId, this.props.genePanelIdToEntrezGeneIds, this.props.onSelectGenePanel, this.props.tooltipIsDisabled),
