...
describe("CoExpressionVizUtils", ()=>{
    describe("computePlotData", ()=>{
        ...
        it("gene set data", ()=>{
            assert.deepEqual(
                computePlotData([
                    {uniqueSampleKey:"sample1", sampleId:"sample1", studyId:"study", genesetId:"abc", value:"2"},
                    {uniqueSampleKey:"sample2", sampleId:"sample2", studyId:"study", genesetId:"abc", value:"4"},
                    {uniqueSampleKey:"sample1", sampleId:"sample1", studyId:"study", genesetId:"def", value:"1.5"},
                    {uniqueSampleKey:"sample2", sampleId:"sample2", studyId:"study", genesetId:"def", value:"10"},
                    // the following data should not appear because only x-axis data for it
                    {uniqueSampleKey:"sample3", sampleId:"sample3", studyId:"study", genesetId:"abc", value:"2"},
                    // the following data should not appear because one is NaN
                    {uniqueSampleKey:"sample4", sampleId:"sample4", studyId:"study", genesetId:"abc", value:NaN},
                    {uniqueSampleKey:"sample4", sampleId:"sample4", studyId:"study", genesetId:"def", value:"1.5"},
                ] as any, [], "abc", "abc", "def", { samples: {}, patients: {} }, {} as any),
                [
                    {x: 2, y: 1.5, mutationsX: "", mutationsY: "", studyId: "study", sampleId: "sample1", profiledX: false, profiledY:false},
                    {x: 4, y: 10, mutationsX: "", mutationsY: "", studyId: "study", sampleId: "sample2", profiledX: false, profiledY: false}
                ]
            );
        });
    });
