...
import {GeneMolecularData, MolecularProfile} from '../../api/generated/CBioPortalAPI';
...
describe('filterCBioPortalWebServiceDataByUnflattenedOQLLine', () => {
    it('returns a single .data object for a single-gene query', () => {
        ...
        const dataArray: GeneMolecularData[] = THREE_GENE_TWO_SAMPLE_CNA_DATA;
