...
export default class GeneSetSelector extends QueryStoreComponent<GeneSetSelectorProps, {}>
{
	...
	{
		return (
			<FlexCol style={{position:'relative'}} padded overflow className={styles.GeneSetSelector}>
				<SectionHeader promises={[this.store.mutSigForSingleStudy, this.store.gisticForSingleStudy, this.store.genes]}>
					Enter Gene Set:
				</SectionHeader>

				<a style={{position:'absolute', right:10, top:3 }} href={getOncoQueryDocUrl()}>Advanced: Onco Query Language (OQL)</a>
